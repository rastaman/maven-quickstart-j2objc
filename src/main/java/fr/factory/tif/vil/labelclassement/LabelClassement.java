...
package fr.factory.tif.vil.labelclassement;
 ...
 * 
 * 
 *  This classes represent a LabelClassement
 * 
 * @version 15 janv. 2004
 * 
 * @author viet
 * 
 * @fdao.class table LABELCLAS_VIL
 * 
 * .
 * 
    ...
    implements java.io.Serializable
{
     ...
     *  Property :
     * 
     * @fdao.id column ID_LABELCLAS_VIL
     * 
     * .
     */
    private Long id;
     ...
     * fr.factory.tif.vil.labelclassement.Label
     * 
     * .
     */
     ...
     * 
     * @fdao.component class
     * fr.factory.tif.vil.labelclassement.ClassementLS
     * 
     * .
     */
    private ClassementLoisirService classementLoisir;
     ...
     * 
     * @fdao.component class
     * fr.factory.tif.vil.labelclassement.ClassementENV
     * 
     * .
     */
    private ClassementEnvironement classementEnvironement;
     ...
     * 
     * @fdao.component class
     * fr.factory.tif.vil.labelclassement.ClassementCS
     * 
     * .
     */
    private ClassementConfortSanitaire classementConfort;

      public ClassementConfortSanitaire getClassementConfort() {
  /* {return

	=* @return ClassementCS
}*/

		return classementConfort;
  }

      public ClassementEnvironement getClassementEnvironement() {
  /* {return

	=* @return ClassementENV
}*/

		return classementEnvironement;
  }

      public ClassementLoisirService getClassementLoisir() {
  /* {return

	=* @return ClassementLS
}*/

		return classementLoisir;
  }
  ...
  /* {return
	...
	=* @return Label
      ...
      public void setClassementConfort(ClassementConfortSanitaire classementCS) {
  /* {param=classementCS

, null=void
}*/

		classementConfort = classementCS;
  }

      public void setClassementEnvironement(ClassementEnvironement classementENV) {
  /* {param=classementENV

, null=void
}*/

		classementEnvironement = classementENV;
  }

      public void setClassementLoisir(ClassementLoisirService classementLS) {
  /* {param=classementLS

, null=void
}*/

		classementLoisir = classementLS;
  }
