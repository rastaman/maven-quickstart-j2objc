...
package fr.factory.tif.vil.animation;
 ...
 * 
 * 
 *  This classes represent a Animation
 * 
 * @version 15 janv. 2004
 * 
 * @author viet
 * 
 * @fdao.class table ANIMATION_VIL
 * 
 * 
 * 
 * .
    ...
    implements java.io.Serializable
{
     ...
     *  Property : 
     * 
     * @fdao.id column ID_ANIMATION_VIL
     * 
     * .
     */
    private Long id;
     ...
     * fr.factory.tif.vil.animation.ThemeAnimation
     * 
     * .
     */
    private ThemeAnimation theme;
     ...
     * 
     * @fdao.component class
     * fr.factory.tif.vil.animation.Disponibilite
     * 
     * .
     */
    private Disponibilite periodeDisponibile;
  ...
  /* {return
	...
	=* @return Long
      ...
      public Disponibilite getPeriodeDisponibile() {
  /* {return

	=* @return Disponibilite
}*/

		return periodeDisponibile;
  }

      public ThemeAnimation getTheme() {
  /* {return
...
, null=void
      ...
      public void setPeriodeDisponibile(Disponibilite disponibilite) {
  /* {param=disponibilite

, null=void
}*/

		periodeDisponibile = disponibilite;
  }

      public void setTheme(ThemeAnimation animation) {
  /* {param=animation
