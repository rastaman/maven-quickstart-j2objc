...
package fr.factory.tif.generic.confort;
...
/**
 *  TypeConfort represent a type TypeConfort for all touriste
 * objects.
 * 
 *  From Ludo to Viet : And what happen if a type confort is
 * applicable 
 * 
 *  to multiples types of objet touristiques ?
 * 
 * @fdao.class table TYPECONFORT
 * 
 *               static true
 * 
    ...
    implements java.io.Serializable
{
     ...
     * 
     * @fdao.component class
     * fr.factory.tif.generic.confort.CategorieConfort
     * 
     * .
     */
    private CategorieConfort categorie;
  ...
  /* {null=void
      ...
      public CategorieConfort getCategorie() {
  /* {return

	=* @return CategorieConfort
}*/

		return categorie;
  }

      public void setCategorie(CategorieConfort confort) {
  /* {param=confort
