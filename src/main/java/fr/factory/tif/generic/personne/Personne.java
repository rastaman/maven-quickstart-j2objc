...
package fr.factory.tif.generic.personne;
...
/**
 *  Personne contains a list of all people, corresponding to the
 * table PERSONNE of the data model
 * 
 * @fdao.class table PERSONNE
 * 
 * .
 * 
    ...
    implements java.io.Serializable
{
    ...
    /**
     *  Person's ID, corresponding to the ID_PERSONNE
     * 
     * @fdao.id column ID_PERSONNE
     * 
     *            size 11
     * 
    ...
    /**
     *  Person's first name, corresponding to the NOM_PERSONNE
     * 
     * @fdao.property column NOM_PERSONNE
     * 
     *                  size   80
     * 
    ...
    /**
     *  Person's last name, corresponding to the PRENOM1_PERSONNE
     * 
     * @fdao.property column PRENOM1_PERSONNE
     * 
     *                  size   80
     * 
     * @tif.property  size   80
    ...
    /**
     *  Person's middle name, corresponding to the PRENOM2_PERSONNE
     * 
     * @fdao.property column PRENOM2_PERSONNE
     * 
     *                  size   80
     * 
     * @tif.property  size   80
    ...
    /**
     * @fdao.component class
     * fr.factory.tif.generic.personne.Civilite
     * 
     * .
     */
