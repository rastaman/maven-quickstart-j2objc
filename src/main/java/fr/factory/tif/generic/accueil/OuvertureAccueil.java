 ...
 * 
 * 
 *  This classes represent a OuvertureAccueil
 * 
 * @fdao.class table OUVERTURE
 * 
 * .
 * 
    ...
    implements java.io.Serializable
{
    ...
    /**
     *  Open date of the Accueil, corresponding to the field
     * DAT_DEBUT_OUVAC of the table
     * 
     * @fdao.property column DAT_DEBUT_OUVAC
     * 
     * .
     */
    ...
    /**
     *  Close date of the Accueil, corresponding to the field
     * DAT_FIN_OUVAC of the table
     * 
     * @fdao.property column DAT_FIN_OUVAC
     * 
     * .
     */
     ...
     * 
     * 
     * @fdao.component class fr.factory.tif.generic.accueil.Horaire
     * 
     *                   table OUVERTURE_HORAIRE
     * 
     * .
     */
     ...
     *  
     * 
     * @fdao.component class fr.factory.tif.generic.temps.Jour
     * 
     *                   table OUVERTURE_JOURFERME
     * 
     * .
     */
    private Vector jourFermerture;

    /**
     * 
     * 
     * @fdao.component class fr.factory.tif.generic.groupe.Groupe
     * 
     *                  table OUVERTURE_GROUPE
     * 
     *  
     * 
     * .
     */
    private Vector groupe;

    /**
     * 
     * 
     * @fdao.property column GROUPEOK
     * 
     *                 size 1
     * 
     * .
     */
    private boolean groupeAccepte = false;

    /**
     * 
     * 
     * @fdao.property column AUTOCAR
     * 
     *                 size 1
     * 
     * .
     */
    private boolean parkingAutoCar = false;
...
, null=void
  ...
  /* {return
	...
	=* @return Vector
      ...
      public boolean isGroupeAccepte() {
  /* {return

	=* @return boolean
}*/

		return groupeAccepte;
  }

      public Vector getJourFermerture() {
  /* {return

	=* @return Vector
}*/

		return jourFermerture;
  }

      public boolean isParkingAutoCar() {
  /* {return

	=* @return boolean
}*/

		return parkingAutoCar;
  }

      public void setGroupe(Vector vector) {
  /* {param=vector
...
, null=void
      ...
      public void setGroupeAccepte(boolean b) {
  /* {param=b
...
, null=void
      ...
      public void setJourFermerture(Vector vector) {
  /* {param=vector

, null=void
}*/

		jourFermerture = vector;
  }

      public void setParkingAutoCar(boolean b) {
  /* {param=b
...
, null=void
      ...
      public Vector getHoraire() {
  /* {null=Returns the horaire.
}*/

		return horaire;
  }

      public void setHoraire(Vector horaire) {
