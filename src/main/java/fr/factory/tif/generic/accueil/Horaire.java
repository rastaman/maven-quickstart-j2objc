 ...
 * @author viet
 * 
 *  This classes represent a Horaire
 * 
 * @fdao.class table HORAIRE
 * 
 * .
 * 
    ...
    implements java.io.Serializable
{
     ...
     *  Open time
     * 
     * @fdao.property column HEURE_OUV
     * 
     * .
     */
    private java.util.Date heureOuverture;

    /**
     *  Close time 
     * 
     * @fdao.property column HEURE_FER
     * 
     * .
     */
    private java.util.Date heureFermeture;

      public Date getHeureFermeture() {
  /* {null=Returns the heureFermeture.
}*/
  ...
  /* {null=Returns the heureOuverture.
}*/
