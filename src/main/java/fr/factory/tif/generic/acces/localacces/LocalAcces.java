...
package fr.factory.tif.generic.acces.localacces;
 ...
 *  
 * 
 *  This class represent a local acces.
 * 
 * @fdao.class table LOCALACCES
 * 
 *              static true
 * 
 * .
    ...
    implements java.io.Serializable
{
     ...
     *  
     * 
     *  Internal ID of object, corresponding to field ID_ZONE
     * 
     * @fdao.id column ID_ZONE
     * 
     * .
     */
    private Long id;
     ...
     *  
     * 
     *  Name of the localisation, corresponding to field NOM_ZONE 
     * 
     * @fdao.property column NOM_ZONE
     * 
     *                  size 40
     * 
     ...
     *  
     * 
     *  Distance from the local acces to the object, corresponding
     * to the field DISTANCE_ZONE 
     * 
     * @fdao.property column DISTANCE_ZONE
     * 
     *                 size 4 
     * 
     * @tif.property size 4
     ...
     *  
     * 
     *  Complement infor of the LocalAcces, corresponding to the
     * field ACCESCOMPL of the table.
     * 
     * @fdao.property column ACCESCOMPL
     * 
     *                  i18n true
     * 
     *                  size 80
     ...
     * fr.factory.tif.generic.acces.localacces.TypeLocalAcces
     * 
     * .
     */
    private TypeLocalAcces typeLocalAcces;
  ...
  /* {null=String
      ...
      public TypeLocalAcces getTypeLocalAcces() {
  /* {null=TypeLocalAcces
}*/

		return typeLocalAcces;
  }
  ...
  /* {null=void
      ...
      public void setTypeLocalAcces(TypeLocalAcces acces) {
  /* {null=void
}*/

		typeLocalAcces= acces;
  }
