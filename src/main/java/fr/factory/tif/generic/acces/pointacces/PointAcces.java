...
package fr.factory.tif.generic.acces.pointacces;
 ...
 *  
 * 
 *  PointAcces contains all informations about point access, 
 * 
 *  corresponding to the table POINTACCES of the datamodel
 * 
 * @fdao.class table POINTACCES
 * 
 *              static true
 * 
 *   
    ...
    implements java.io.Serializable
{
     ...
     *  
     * 
     *  Internal ID of PointAcces, corresponding to field ID_POINT
     * of the table POINTACCES
     * 
     * @fdao.id column ID_POINT
     * 
     * .
     */
    private Long id;
     ...
     *  
     * 
     *  Name of the point acces, corresponding to field NOM_POINT
     * of the table POINTACCES
     * 
     * @fdao.property column NOM_POINT
     * 
     *                 size 40
     * 
     * @tif.property  size 40
     * 
     * .
     */
    private String nom;
     ...
     *  
     * 
     *  Distance from the point acces to the Object
     * 
     * @fdao.property column DISTANCE_POINT
     * 
     *                  size 4
     * 
     * @tif.property  size 4
     ...
     * 
     * 
     * @fdao.component class fr.factory.tif.generic.utils.Mesure
     * 
     * .
     */
     ...
     *  
     * 
     *  Complement information of the PointAcces, corresponding to
     * the field POINTACCESCOMPL of the table
     * 
     * @fdao.property column POINTACCESCOMPL
     * 
     *                  i18n true
     * 
     *                  size 80
     ...
     * 
     * @fdao.component class
     * fr.factory.tif.generic.acces.pointacces.TypePointAcces
     * 
     * .
     */
    private TypePointAcces typePointAcces;
  ...
  /* {null=String
      ...
      public TypePointAcces getTypePointAcces() {
  /* {null=TypePointAcces
}*/

		return typePointAcces;
  }
  ...
  /* {null=void
      ...
      public void setDistance(Long long1) {
  /* {null=void
}*/
  ...
  /* {null=void
      ...
      public void setTypePointAcces(TypePointAcces acces) {
  /* {null=void
}*/

		typePointAcces= acces;
  }
