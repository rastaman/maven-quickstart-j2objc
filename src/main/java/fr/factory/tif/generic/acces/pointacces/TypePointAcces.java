 ...
 *  
 * 
 *  TypePointAcces contains all types of point acces, 
 * 
 *  corresponding to the table TYPEPOINTACCES of the data model
 * 
 *  
 * 
 * @fdao.class table TYPEPOINTACCES
 * 
 *              static true
 * 
