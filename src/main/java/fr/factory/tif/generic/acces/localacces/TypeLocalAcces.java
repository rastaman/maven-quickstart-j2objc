 ...
 *  
 * 
 *  TypeLocalAcces contains all type of local acces, 
 * 
 *  corresponding to the table TYPELOCALACCES of the data model
 * 
 *  
 * 
 * @fdao.class table TYPELOCALACCES
 * 
 *              static true
 * 
