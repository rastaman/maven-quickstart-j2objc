...
/**
 *  Region contains all regions of one country,corresponding to the
 * table REGION of the data model
 * 
 * @fdao.class table REGION
 * 
 *               static true
 * 
 * @fdao.subclass type fr.factory.tif.generic.utils.Biface
 * 
 * .
 * 
    ...
    implements java.io.Serializable
{
    ...
    /**
     * @fdao.component class fr.factory.tif.generic.geographie.Pays
     * 
     * .
     */
    private Pays pays;
     ...
     * fr.factory.tif.generic.geographie.Departement
     * 
     * @element-type Departement
     * 
     * .
     */
    private Vector departement;
     ...
     * 
     * @element-type ZoneLocale
     * 
     * .
     */
    private Vector zoneLocale;
  ...
  /* {null=Vector
      ...
      public void setPays(Pays pays1) {
  /* {null=void
}*/
      ...
      public void setZoneLocale(Vector vector) {
  /* {null=void
}*/
  ...
  /* {null=Vector
      ...
      public void setDepartement(Vector vector) {
  /* {null=void
}*/

		this.departement= vector;
  }
