...
/**
 *  Commune contains all commune of one Canton, corresponding to
 * the table COMMUNE of the data model
 * 
 * @fdao.class table COMMUNE
 * 
 *               static true
 * 
 * .
    ...
    implements java.io.Serializable
{
    ...
    /**
     *  Object's internal ID, corresponding to the field ID_COMMUNE
     * 
     * @fdao.id column ID_COMMUNE
     * 
     * .
     */
    private Long id;
    ...
    /**
     *  Name of the commune, corresponding to the field NOM_COMMUNE
     * 
     * @fdao.property column NOM_COMMUNE
     * 
     *                  size   40
     * 
     * .
    ...
    /**
     *  Postal Code of the commune, corresponding to the field
     * CP_COMMUNE
     * 
     * @fdao.property column CP_COMMUNE
     * 
     *                  size 5
     * 
     * .
    ...
    /**
     *  InSEE of the commune, corresponding to the field
     * INSEE_COMMUNE 
     * 
     * @fdao.property column INSEE_COMMUNE
     * 
     *                  size   11
     * 
     * .
     ...
     * fr.factory.tif.generic.geographie.Canton
     * 
     * .
     */
    ...
    /**
     * @fdao.component class
     * fr.factory.tif.generic.geographie.Microregion
     * 
     * .
     */
  ...
  /* {null=String
      ...
      public void setCanton(Canton canton1) {
  /* {null=void
}*/
  ...
  /* {null=void
      ...
      public void setInSEE(String string) {
  /* {null=void
}*/
