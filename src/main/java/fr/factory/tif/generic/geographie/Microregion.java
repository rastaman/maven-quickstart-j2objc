...
/**
 *  Microregion contains a list of all Microregion, corresponding
 * to the table MICROREGION of the data model
 * 
 * @fdao.class table MICROREGION
 * 
 *               static true
 * 
 * .
    ...
    implements java.io.Serializable
{
    ...
    /**
     *  Libelle of the microregion, corresponding to the field
     * LIB_MICROREGION
     * 
     * @fdao.property column LIB_MICROREGION
     * 
     *                  size   160
     * 
     * .
     ...
     * .
     */
    private Vector commune;

      public Vector getCommune() {
  /* {null=Vector
}*/
  ...
  /* {null=String
      ...
      public void setCommune(Vector vector) {
  /* {null=void
}*/
