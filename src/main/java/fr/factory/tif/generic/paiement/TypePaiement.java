...
package fr.factory.tif.generic.paiement;
...
/**
 *  TypePaiement contains all types of paiement, corresponding to
 * the table MODEPAIEM of the date model
 * 
 * @fdao.class table MODEPAIEM
 * 
 *               static true
 * 
