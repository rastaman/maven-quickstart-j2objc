 ...
 *  
 * 
 *   Liste of all types of Capacite
 * 
 * @fdao.class table TYPECAPACITE
 * 
 *               static true
 * 
    ...
    implements java.io.Serializable
{
     ...
     * 
     * 
     *  Type container of the TypeCapacite <br>
     * 
     *  Ex : '1' -> TypeCapacite of Espace <br>
     * 
     *       '2' -> TypeCapacite of ObjetTouristique
     * 
     * @fdao.property column CONTAINER_
     * 
     *                 size 1
     * 
     * .
     */
    private int typeContainer = 0;
  ...
  /* {return
	...
	=* @return int
      ...
      public void setTypeContainer(int i) {
  /* {param=i
