...
package fr.factory.tif.generic.contact;
...
/**
 *  Contact contains all contact informations , corresponding to
 * the table CONTACT of the data model.
 * 
 * @fdao.class table CONTACT
 * 
 * .
 * 
    ...
    implements java.io.Serializable
{
    ...
    /**
     *  Object's internal ID, corresponding to the field ID_CONT
     * 
     * @fdao.id column ID_CONT
     * 
     * .
     */
    private Long id;
    ...
    /**
     *  Fonction of contact, corresponding to the field
     * FONCTION_CONT
     * 
     * @fdao.property column FONCTION_CONT
     * 
     *                  i18n true
     * 
     *                  size 40
    ...
    /**
     *  Person who is associated with Contact
     * 
     * @fdao.component class
     * fr.factory.tif.generic.personne.Personne
     * 
     * .
     */
     ...
     * 
     * @fdao.component class
     * fr.factory.tif.generic.contact.TypeContact 
     * 
     * .
     */
  ...
  /* {null=void
      ...
      public void setTypeContact(TypeContact contact) {
  /* {null=void
}*/
  ...
  /* {null=void
      ...
      public void setFonction(String[] strings) {
  /* {param=strings
}*/
