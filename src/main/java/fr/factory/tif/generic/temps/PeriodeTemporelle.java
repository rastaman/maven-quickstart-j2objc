...
package fr.factory.tif.generic.temps;
...
/**
 *  PeriodeTemporelle contains a list of time interval,
 * corresponding to the table PERIOD_TEMPORELLE of the data model
 * 
 * @fdao.class table PERIOD_TEMPORELLE
 * 
 * .
 * 
...
public class PeriodeTemporelle
    implements java.io.Serializable
{
    ...
    /**
     *  Object's internal ID, corresponding to the field ID_PERIODE
     * of the tables
     * 
     * @fdao.id column ID_PERIODE
     * 
     * .
     */
    private Long id;
    ...
    /**
     *  Starting date of the periode, corresponding to the field
     * DEB_PERIODE of the table
     * 
     * @fdao.property column DEB_PERIODE
     * 
     * .
     */
    private java.util.Date periodeDateDedut;

    /**
     *  End date of the periode, corresponding to the field
     * FIN_PERIODE of the table
     * 
     * @fdao.property column FIN_PERIODE
     * 
     * .
     */
    private java.util.Date periodeDateFin;

    /**
     * @fdao.component class
     * fr.factory.tif.generic.temps.PeriodeTemporelle
     * 
     *   table PERIODE_SAISON
     * 
     * .
     */
  ...
  /* {null=Long
      ...
      public Date getPeriodeDateDedut() {
  /* {null=Date
}*/

		return periodeDateDedut;
  }
  ...
  /* {null=void
      ...
      public void setPeriodeDateDedut(Date date) {
  /* {null=void
}*/

		periodeDateDedut= date;
  }

      public void setPeriodeDateFin(Date date) {
  /* {null=void
}*/
