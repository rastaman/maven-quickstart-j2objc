...
/**
 *  Saison contains a list of seasons, corresponding to the table
 * SAISON of the data model
 * 
 * @fdao.class table SAISON
 * 
    ...
    implements java.io.Serializable
{
     ...
     * 
     * @element-type PeriodeTemporelle
     * 
     * .
     */
    private Vector periodeTemporelle;

      public Vector getPeriodeTemporelle() {
  /* {null=Vector
}*/

		return periodeTemporelle;
  }

      public void setPeriodeTemporelle(Vector vector) {
  /* {null=void
}*/

		periodeTemporelle= vector;
  }
