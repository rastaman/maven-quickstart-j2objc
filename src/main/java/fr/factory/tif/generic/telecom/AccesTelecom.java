...
package fr.factory.tif.generic.telecom;
...
/**
 *  AccesTelecom contains all informations about acces telecom,
 * corresponding to the table ACCESTELECOM of the data model
 * 
 * @fdao.class table ACCESTELECOM
 * 
 * .
 * 
    ...
    implements java.io.Serializable
{
    ...
    /**
     *  Internal ID of object, corresponding to the field ID_COMM
     * 
     * @fdao.id column     ID_COMM
     * 
     *            size       11
     * 
    ...
    /**
     *  Coordonnees of AccesTelecom,corresponding to the field
     * COORD_COMM
     * 
     * @fdao.property column COORD_COMM
     * 
     *                 size 80 
     * 
    ...
    /**
     *  Complement of AccesTelecom, corresponding to the field
     * COMPL_COMM
     * 
     * @fdao.property column COMPL_COMM
     * 
     *                 size 80 	
     * 
     * @tif.property  size 80
     ...
     * fr.factory.tif.generic.telecom.TypeTelecom
     * 
     * .
     */
    private TypeTelecom typeTelecom;
  ...
  /* {null=Long
      ...
      public TypeTelecom getTypeTelecom() {
  /* {null=TypeTelecom
}*/
  ...
  /* {null=void
      ...
      public void setCoordonnees(String string) {
  /* {null=void
}*/
  ...
  /* {null=void
      ...
      public void setTypeTelecom(TypeTelecom telecom) {
  /* {null=void
}*/
