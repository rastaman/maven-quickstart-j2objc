...
/**
 *  TypeTelecom contains all types of Acces Telecom, corresponding
 * to the table TYPETELECOM of the date model
 * 
 * @fdao.class table TYPETELECOM
 * 
 *               static true 
 * 
