 ...
 * 
 * 
 * @fdao.class table DESCRIPTION_RES
 * 
 *  
 * 
 * .
    ...
    implements java.io.Serializable
{
     ...
     * 
     * 
     *  Description about rooms of the Restauration
     * 
     * @fdao.property column DESCRIPT
     * 
     *                 i18n true
     * 
     *                 size 500
     * 
     * @tif.property  size 500
     * 
     * .
     */
    private String[] descriptionSalles;

    /**
     * 
     * 
     *  Description about the halls of the Restauration
     * 
     * @fdao.property column DESCREUN
     * 
     *                 i18n true
     * 
     *                 size 500 
     ...
     * .
     */
    private String[] descriptionReunions;
  ...
  /* {param=long1
      ...
      public String[] getDescriptionReunions() {
		return descriptionReunions;
  }

      public String[] getDescriptionSalles() {
		return descriptionSalles;
  }

      public void setDescriptionReunions(String[] strings) {
  /* {param=strings
}*/

		descriptionReunions = strings;
  }

      public void setDescriptionSalles(String[] strings) {
  /* {param=strings
}*/

		descriptionSalles = strings;
  }
