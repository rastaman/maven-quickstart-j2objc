...
/**
 *  Description constains description informations about
 * ObjetTouristique, corresponding to the table DESCRIPTION of the
 * data model
 * 
 * @fdao.class table DESCRIPTION
 * 
 * .
 * 
    ...
    implements java.io.Serializable
{
    ...
    /**
     *  Object's internal ID, corresponding to the field
     * ID_DESCRIPTION of the table.
     * 
     * @fdao.id column ID_DESCRIPTION
     * 
     * .
     */
    private Long id;
    ...
    /**
     *  Main description informations (commercial description, for
     * example), of the ObjetTouristique, corresponding to the
     * field DESCRIPTION of the table
     * 
     * @fdao.property column  DESCRIPTION
     * 
     *                  i18n    true
     * 
     *                  size    800
     * 
     * @tif.property  size    800
     * 
     * .
     */
    private String[] descriptionCommerciale;

    /**
     *  Secondary field of description, contains another
     * description informations (technic description, for example)
     * of the ObjetTouristique, corresponding to the field
     * DESCRIPTION2 of the table.
     * 
     * @fdao.property column  DESCRIPTION2
     * 
     *                  i18n    true
     * 
     *                  size    800
    ...
    /**
     * @fdao.property column  DESCRIPTION3
     * 
     *                  i18n    true
     * 
     *                  size    800
     ...
     * .
     */
    private String[] descriptionParticuliere;
    ...
    /**
     * Method breakObjetTouristiqueAbstraitAssociation.
     * 
     * @param objetTouristiqueAbstrait
     */
    public void breakObjetTouristiqueAbstraitAssociation( ObjetTouristiqueAbstrait objetTouristiqueAbstrait )
    {
        if ( this.objetTouristiqueAbstrait != objetTouristiqueAbstrait )
        {
            throw new IllegalStateException( "objetTouristiqueAbstrait isn't associated." );
        }

        this.objetTouristiqueAbstrait = null;
    } //-- void breakObjetTouristiqueAbstraitAssociation( ObjetTouristiqueAbstrait )

    /**
     * Method createObjetTouristiqueAbstraitAssociation.
     * 
     * @param objetTouristiqueAbstrait
     */
    public void createObjetTouristiqueAbstraitAssociation( ObjetTouristiqueAbstrait objetTouristiqueAbstrait )
    {
        if ( this.objetTouristiqueAbstrait != null )
        {
            breakObjetTouristiqueAbstraitAssociation( this.objetTouristiqueAbstrait );
        }

        this.objetTouristiqueAbstrait = objetTouristiqueAbstrait;
    } //-- void createObjetTouristiqueAbstraitAssociation( ObjetTouristiqueAbstrait )
  ...
  /* {null=void
      ...
      public String[] getDescriptionCommerciale() {
		return descriptionCommerciale;
  }
      ...
      public void setDescriptionCommerciale(String[] strings) {
  /* {param=strings
}*/

		descriptionCommerciale = strings;
  }

      public void setDescriptionTechnique(String[] strings) {
  /* {param=strings
}*/

		descriptionTechnique = strings;
  }
  ...
  /* {param=abstrait
      ...
      public String[] getDescriptionParticuliere() {
  /* {return

	=* @return String[]
}*/

		return descriptionParticuliere;
  }

      public void setDescriptionParticuliere(String[] strings) {
  /* {param=strings

, null=void
}*/

		descriptionParticuliere = strings;
  }
